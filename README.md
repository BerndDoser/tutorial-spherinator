...
- [`emojis_training.ipynb`](jupyter/emojis_training.ipynb)  
  ...
  Trains a quick demo model and exports it to ONNX.
- [`emojis_inference.ipynb`](jupyter/emojis_inference.ipynb)  
  [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/BerndDoser/Tutorial-Spherinator/blob/master/jupyter/emojis_inference_colab.ipynb)  
